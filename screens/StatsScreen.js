...
// Helper lấy ngày hiện tại và đầu tháng
...
export default function StatsScreen() {
  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      if (err.response?.status === 404) {
        Alert.alert('Thông báo', 'Không tìm thấy dữ liệu trong khoảng thời gian này.');
      } else {
  ...
  // Component con: Thẻ thống kê tổng quan
  ...
  // Component con: Dòng chi tiết công thức
